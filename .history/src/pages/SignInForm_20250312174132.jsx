  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen">
          ...
          return (
            ...
            >
              ...
              <div className="text-right ">
                <a href="/forgot-password" className="text-blue-400 font-light">
                  Forgot password?
                </a>
              </div>
              <div>
                <button
                  ...
                  className="w-full p-4 bg-blue-500 font-semibold rounded-lg text-white mt-2 "
                >
                  Submit
                </button>
              </div>
      ...
      <div>
        ...
        <a href="/signup" className="text-blue-600 font-semibold ml-2">
          Sign up
        </a>
      </div>
    </div>
