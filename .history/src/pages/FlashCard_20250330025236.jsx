      ...
      <div className="mt-6 flex gap-6 justify-center items-center">
        ...
        >
          ...
          >
            {/* Mặt trước */}
            <div
              className={`absolute w-full h-full bg-white shadow-blue-500/50 rounded-xl p-8 text-2xl font-bold flex flex-col items-center justify-center transition-opacity duration-500 ${
