...
const SignInForm = () => {
  return (
    <div className="flex flex-col justify-center items-center h-screen">
      ...
      <div className="relative flex items-center justify-center mt-8 text-gray-500 font-semibold text-xl before:w-1/3 before:h-[1px] before:bg-gray-300 before:absolute before:left-0 before:top-1/2 after:w-1/3 after:h-[1px] after:bg-gray-300 after:absolute after:right-0 after:top-1/2">
        Or
      </div>
