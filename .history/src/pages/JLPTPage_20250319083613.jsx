  ...
  return (
    <div className="p-4 bg-gray-100 min-h-screen">
      <div className="flex justify-between space-x-4 mb-4">
        <div className="flex justify-start p-4 gap-2 border border-gray-300 rounded-3xl">
          <button className="px-4 py-2 bg-yellow-400 text-white font-bold rounded rounded-3xl">
            JLPT
          </button>
