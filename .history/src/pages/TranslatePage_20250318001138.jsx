      ...
      <div className="grid grid-cols-12 gap-4 max-w-4xl w-full">
        ...
        <div className="col-span-2 flex flex-col justify-center items-center space-y-4">
          <button
            ...
            className="p-2 bg-white text-black rounded-lg shadow-md border border-gray-300 hover:bg-gray-200 transition"
          >
          ...
          <button
            ...
            className="px-4 py-2 flex item-center w-[100px] min-w-[100px] bg-indigo-500 text-white rounded shadow hover:bg-indigo-600"
          >
            Translate
          </button>
        </div>
