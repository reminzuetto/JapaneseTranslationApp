      ...
      >
        ...
        >
          ...
          >
            ...
            <p className="text-sm font-thin text-gray-500 mt-3">
          ...
          >
            ...
            <div className="mt-4 flex ">
              <p className="pl-5 text-lg size-semibold text-gray-800">
                Meaning:
              </p>
              <ul className="list-disc pl-5 text-lg font-semibold text-gray-800">
