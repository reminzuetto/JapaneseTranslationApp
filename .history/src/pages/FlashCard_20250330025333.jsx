        ...
        >
          ...
          >
            ...
            <div
              ...
              className={`absolute w-full h-full bg-whit shadow-lg rounded-xl p-8 text-2xl font-bold flex flex-col items-center justify-center transition-opacity duration-500 ${
