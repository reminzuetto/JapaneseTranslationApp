    ...
    <div className="p-4 bg-gray-100 min-h-screen">
      <div className="flex justify-between space-x-4 mb-4">
        ...
        <div className="flex justify-end gap-4 p-4">
          <button className=" text-white bg-blue-200 p-2 rounded-lg hover:bg-blue-500 cursor-pointer selectedLevel">
            N5
          </button>
          ...
          {selectedLevel && (
            <button
              className="text-white bg-blue-200 p-2 rounded-lg hover:bg-blue-500 cursor-pointer"
