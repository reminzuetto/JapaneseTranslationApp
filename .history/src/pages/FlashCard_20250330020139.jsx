    ...
    <div className="flex flex-col items-center p-6">
      ...
      >
        <div className="relative w-full h-full">
          {/* Mặt trước */}
          <div
            className={`absolute w-full h-full bg-white border border-gray-500 shadow-lg rounded-xl p-6 flex flex-col items-center justify-center transition-opacity duration-500 ${
