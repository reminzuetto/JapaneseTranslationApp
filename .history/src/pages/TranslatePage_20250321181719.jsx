...
const TranslatePage = () => {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-gray-100 p-4 mr-[100px]">
      <div className="grid grid-cols-12 gap-4 max-w-4xl w-full">
        ...
        <div className="col-span-2 flex justify-center items-center">
          <button
            ...
            className="p-1 bg-white text-black w-[80px] border border-gray-500 rounded-lg shadow-md hover:bg-gray-200 transition"
          >
