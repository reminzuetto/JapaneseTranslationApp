  ...
  return (
    <div className="p-4 bg-gray-100 min-h-screen">
      ...
      <div className="flex">
        ...
        <div className="flex flex-col justify-start items-center bg-white p-4 rounded shadow">
          <h2 className="text-lg font-bold">Thông tin bài thi N5</h2>
          <div className="text-sm flex flex-col justify-center items-center py-4">
