      ...
      >
        ...
        >
          ...
          >
            ...
            <div>
              <p className="text-xl font-bold text-gray-700 mt-3">📖 Nghĩa:</p>
              <ul className="mt-1 list-disc pl-5 text-lg size-semibold text-gray-800">
                {currentWord.word_uses[0].word_means.map((mean) => mean)}
              </ul>
            </div>
