...
const Flashcard = () => {
  ...
  return (
    <div className="flex flex-col items-center p-6">
      ...
      >
        <div
          className={`absolute w-full h-full bg-white border border-gray-500 shadow-lg rounded-lg p-6 text-xl font-semibold flex items-center justify-center transition-transform transform ${
        ...
        >
          {!flipped ? (
            ...
            <div className="text-center">
              ...
              <ul className="mt-2">
                {words[currentIndex].word_uses.word_means.map((mean, index) => (
