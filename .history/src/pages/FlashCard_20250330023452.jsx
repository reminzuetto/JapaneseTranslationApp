...
const Flashcard = () => {
  ...
  return (
    <div className="flex flex-col items-center p-6">
      ...
      <div
        className="relative w-150 h-100 perspective-1000"
      ...
      >
        ...
        >
          ...
          >
            <p className="text-8xl text-blue-500">{currentWord.word}</p>
            <p className="text-2xl font-light text-gray-500 mt-3">
          ...
          >
            ...
            <div className="mt-4 flex">
              <p className="pl-5 text-lg font-medium text-gray-800">Meaning:</p>
              <ul className="list-disc pl-2 text-lg font-medium text-gray-800">
