  ...
  return (
    <div className="flex flex-col items-center p-6">
      ...
      <div className="mt-6 flex gap-6 justify-center items-center">
        <button
          className="rounded-full text-lg hover:bg-gray-200 transition w-[50px] h-[50px]"
        ...
        >
          ...
          >
            {/* Mặt trước */}
            <div
              className={`absolute w-full h-full bg-white shadow-2xl rounded-xl p-8 text-2xl font-bold flex flex-col items-center justify-center transition-opacity duration-500 ${
                flipped ? "opacity-0" : "opacity-100"
              }`}
            >
              <p className="text-5xl text-blue-500">{currentWord.word}</p>
            ...
            <div
              ...
              className={`absolute w-full h-full bg-white shadow-lg rounded-xl p-8 text-2xl font-bold flex flex-col items-center justify-center transition-opacity duration-500 ${
