  ...
  return (
    <div className="flex flex-col items-center p-6">
      ...
      <div className="mt-6 flex gap-6 justify-center items-center">
        <button
          className="bg-gray-500 text-white px-5 py-3 rounded-full text-lg hover:bg-gray-600 transition w-[50px] h-[50px]"
        ...
        <button
          className="bg-blue-500 text-white px-5 py-3 rounded-full text-lg hover:bg-blue-600 transition w-[50px] h-[50px]"
          onClick={handleNext}
        >
          Tiếp
        </button>
