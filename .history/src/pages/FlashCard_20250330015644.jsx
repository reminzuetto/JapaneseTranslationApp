    ...
    <div className="flex flex-col items-center p-6">
      ...
      >
        ...
        >
          {/* Mặt trước */}
          <div
            className="absolute w-full h-full bg-white border border-gray-500 shadow-lg rounded-lg p-6 text-xl font-semibold flex flex-col items-center justify-center"
          ...
          {/* Mặt sau */}
          <div
            className="absolute w-full h-full bg-white border border-gray-500 shadow-lg rounded-lg p-4 text-lg font-semibold flex flex-col justify-center rotate-y-180"
            style={{
