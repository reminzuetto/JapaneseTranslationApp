...
const DropdownButton = () => {
  ...
  return (
    <div className="relative w-64 mx-auto" ref={dropdownRef}>
      {/* Nút dropdown */}
      <div
        className="w-full flex items-center justify-between bg-blue-500 text-white text-lg font-semibold px-4 py-3 rounded-md hover:bg-red-600 transition cursor-pointer"
      ...
      {/* Danh sách dropdown */}
      <ul
        className={`absolute left-0 right-0 mt-2 bg-red-500 text-white text-lg rounded-md shadow-lg z-10 transition-all duration-200 ${
          isOpen ? "block" : "hidden"
        }`}
      >
