...
const Sidebar = ({ isOpen, setIsOpen }) => {
  const menuItems = [
    { src: "/assets/SearchIcon.png", text: "Search" },
    { src: "/assets/TranslateIcon.png", text: "Translate" },
    { src: "/assets/CollectionIcon.png", text: "Collection" },
    { src: "/assets/JLPTIcon.png", text: "JLPT" },
    { src: "/assets/AboutIcon.jpg", text: "About us" },
  ];
        ...
        <li className="w-full text-center py-4 bg-blue-700 font-bold uppercase text-white text-2xl">
          <a className="flex items-center justify-center space-x-4" href="#">
            <img
              ...
              src="/assets/MaziiLogo.png"
              alt="Mazii logo"
            />
            <span className={`ml-2 ${isOpen ? "block" : "hidden"}`}>Mazzi</span>
          </a>
        </li>
