...
const SidebarItem = ({ src, text }) => (
  <li className="w-full">
    <a
      className="flex items-center h-20 text-gray-200 no-underline transition duration-500 hover:bg-blue-700 hover:text-white"
      href=""
    >
  ...
  return (
    <nav className="w-20 h-screen fixed z-10 bg-blue-600 transition-all duration-200 hover:w-64 group">
      <ul className="flex flex-col items-center space-y-2">
        <li className="w-full text-center py-4 bg-blue-700 font-bold uppercase text-white text-3xl">
