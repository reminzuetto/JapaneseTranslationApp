...
const SidebarItem = ({ src, text }) => (
  <li className="w-full">
    <a
      className="flex items-center h-20 text-gray-200 no-underline transition duration-500 hover:bg-blue-700 hover:text-white hover:shadow-lg hover:font-bold hover:rounded-lg"
      href=""
    >
