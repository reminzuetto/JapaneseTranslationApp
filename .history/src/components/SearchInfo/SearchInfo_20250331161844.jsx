...
const SearchInfo = ({ selectedWord, onClose }) => {
  ...
  return (
    <div className=" inset-0 mt-3 fixed flex items-center justify-center bg-black bg-opacity-50 z-50">
          ...
          <div className="text-gray-700 text-lg">
            ...
            {selectedWord.word_uses.map((use, index) => (
              <div key={index} className="mb-3 bg-gray-100">
                <p className="mb-3 p-3 rounded-lg font-semibold text-white bg-gradient-to-r from-yellow-400 to-white">
