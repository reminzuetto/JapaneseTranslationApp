          ...
          <div className="text-gray-700 text-lg">
            ...
            {selectedWord.word_uses.map((use, index) => (
              <div key={index} className="mb-3 bg-gray-100">
                <p className="mb-3 text-white bg-yellow-300 p-3 rounded-lg font-semibold transition-all duration-300 ease-in-out opacity-0 translate-y-2 animate-fade-in">
