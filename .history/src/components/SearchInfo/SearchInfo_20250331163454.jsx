...
const SearchInfo = ({ selectedWord }) => {
  if (!selectedWord) return null;

  return (
    <div className=" inset-0 mt-10">
      <div className="bg-white rounded-lg w-250">
        ...
        <p className="text-lg text-blue-500 mb-3">
          ...
          <div className="text-gray-700 text-lg">
            ...
            {selectedWord.word_uses.map((use, index) => (
              <div key={index} className="mb-3 bg-gray-100">
                <p className="mb-3 p-3 rounded-lg font-semibold text-[#bd9356] bg-gradient-to-r from-[#ffedcc] to-white">
                  <FontAwesomeIcon icon={faStar} className="mr-2" />{" "}
                  {use.word_type}
                </p>
                <p className="text-lg text-blue-500 mb-3 italic">
                  <FontAwesomeIcon icon={faDiamond} />{" "}
                  {use.word_means.join(", ")}
                </p>
                <p className="mb-3">
