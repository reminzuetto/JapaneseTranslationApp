...
function DropdownButton() {
  ...
  return (
    <div className="relative w-40 mx-10" ref={dropdownRef}>
      <button
        className="flex items-center justify-between bg-blue-500 text-white text-lg font-semibold px-4 py-3 rounded-lg hover:bg-blue-600 transition cursor-pointer"
