...
function LanguageSelector({ type, value, onChange, options }) {
  ...
  const bgColor = type === "from" ? "bg-blue-500" : "bg-white-500";
  const hoverColor =
  ...
  return (
    <div className="relative w-auto mx-10" ref={dropdownRef}>
      ...
      <button
        className={`flex items-center justify-between ${bgColor} text-white font-medium px-4 py-3 rounded-lg ${hoverColor} transition cursor-pointer w-40`}
