...
function LanguageSelector({ type, value, onChange, options }) {
  ...
  return (
    <div className="relative w-auto mx-10" ref={dropdownRef}>
      <button
        className={`flex items-center justify-between ${bgColor} font-medium px-4 py-3 rounded-lg hover:bg-blue-600 ${textColor} ${border} transition cursor-pointer w-40`}
