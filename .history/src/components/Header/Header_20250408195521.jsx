          ...
          <div className="relative" ref={userDropdownRef}>
            ...
            {showUserDropdown && (
              <div className="absolute top-full right-0 mt-2 w-48 bg-white border rounded shadow-lg p-4 z-50">
                ...
                <div className="flex items-end justify-end text-gray-500 mr-2 mb-2 cursor-pointer shadow-sm hover:shadow-md rounded-lg p-2 mt-2">
                ...
                <button
                  ...
                  className="w-full text-left text-red-500 hover:underline mt-2"
                >
                  <FontAwesomeIcon
