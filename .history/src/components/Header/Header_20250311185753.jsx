  ...
  return (
    <header className="flex items-center justify-between p-4 bg-white shadow-md">
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="px-4 py-2 text-blue bg-gray-200 rounded-lg h over:bg-blue-500 hover:text-white">
          Sign up
        </button>
        <div ref={nodeRef} className="relative">
          ...
          {show && (
            <div
              className="p-5 border-gray-200 rounded-lg absolute top-full left-0 w-full bg-white shadow-lg"
