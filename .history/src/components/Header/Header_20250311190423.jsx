    ...
    <header className="flex items-center justify-between p-4 bg-white shadow-md">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative" ref={nodeRef}>
          ...
          {show && (
            <div className="absolute top-full left-0 min-w-[200px] translate-x-[-100%] mt-2 bg-white shadow-lg rounded-lg border border-gray-200">
              <div className="py-3 px-4 border-b border-gray-200 cursor-pointer hover:bg-gray-100">
                JavaScript
              </div>
              <div className="py-3 px-4 border-b border-gray-200 cursor-pointer hover:bg-gray-100">
                ReactJS
              </div>
              <div className="py-3 px-4 cursor-pointer hover:bg-gray-100">
                VueJS
              </div>
            </div>
          )}
